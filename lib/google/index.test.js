...
test('translate simple', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var rq, res, json;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
            switch (_context4.prev = _context4.next) {
                case 0:
                    rq = _2.default.translate(TEST_LANG, TEST_QUESTION, TEST_SRC, TEST_TARGET, true);
                    _context4.next = 3;
                    return (0, _nodeFetch2.default)(rq.url, {
                        method: rq.method,
                        headers: rq.headers,
...
test('tts', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var rq, res, data;
